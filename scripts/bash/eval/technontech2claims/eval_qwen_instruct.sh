...
models=(
  ...
  # "models/lora_model_Qwen2.5-7B-Instruct.technontech2claims_instruct.r128_la64_lr1e-05_e3_s-1_wu100_bs2_schlinear_optadamw_8bit_emb_lm"
)
...
PROMPT_MODE="technontech2claims_instruct"
# Task name
